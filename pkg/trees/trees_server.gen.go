...
func (w *ServerInterfaceWrapper) GetDicoTable(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "table", ctx.Param("table"), &table, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) GetGestionComEmplacementsCentroidEmplacementId(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "emplacementId", ctx.Param("emplacementId"), &emplacementId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) GetBuildingCenter(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "addressId", ctx.Param("addressId"), &addressId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) GetBuildingsNumbers(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "streetId", ctx.Param("streetId"), &streetId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) Delete(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "treeId", ctx.Param("treeId"), &treeId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
